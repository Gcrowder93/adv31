...
const mockmonsters = {
  data: [
    ...
    {
      category: 'monsters',
      common_locations: ['Lanayru Great Spring', 'Gerudo Desert'],
      description:
      ...
      drops: ['lizalfos horn', 'lizalfos talon'],
      id: 113,
    ...
    {
      category: 'monsters',
      common_locations: ['Divine Beast Vah Rudania'],
      description:
    ...
    },
    {
      ...
      description:
        'These quick-witted, lizard-like monsters can be found all over Hyrule. The balls of ice they spit make them particularly troublesome, but exposure to fire will kill them instantly. Their homes are mainly on snowy mountains.',
      drops: ['lizalfos horn', 'lizalfos talon', 'icy lizalfos tail'],
      id: 118,
    ...
    {
      category: 'monsters',
      common_locations: ['Lanayru Great Spring', 'Hyrule Field'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Death Mountain'],
      description:
        'These sentries dispatched from Divine Beast Vah Rudania are equipped with searchlights that can spot intruders.',
      drops: ['ancient screw', 'ancient spring', 'ancient gear', 'ancient shaft', 'ancient core'],
      id: 128,
    ...
    {
      category: 'monsters',
      common_locations: ['Hyrule Field', 'Gerudo Highlands'],
      description:
        "Although Bokoblins are generally a nuisance, the Black Bokoblins are among the most dangerous type. They're extremely resilient, and many are armed with more advanced weapons.",
    ...
    {
      category: 'monsters',
      common_locations: ['Gerudo Highlands', 'Tabantha Frontier'],
      description:
      ...
      drops: ['octorok tentacle', 'octo balloon', 'octorok eyeball'],
      id: 95,
    ...
    {
      category: 'monsters',
      common_locations: ['Hyrule Field', 'Eldin Canyon'],
      description:
    ...
    },
    {
      ...
      description:
        'These spell-casting monsters can be found all over Hyrule. They use their blizzard rods to create freezing blasts of air or to summon frozen monsters and have been known to cause blizzards to severely decrease the temperature around them. The weather will normalize once the Blizzrobe is defeated.',
      drops: [],
      id: 101,
    ...
    {
      category: 'monsters',
      common_locations: ['East Necluda', 'Hyrule Field'],
      description:
    ...
    },
    {
      ...
      common_locations: null,
      description:
        'The strongest of all Moblins, Ganon\'s fiendish magic has allowed them to surpass even the Black Moblins in strength and resilience. They\'re called "silver" for both their body color as well as their rarity. The purple patterns on their bodies also help them to stand out.',
      drops: [
        'moblin horn',
        'moblin fang',
        'moblin guts',
    ...
    },
    {
      ...
      drops: ['green rupee', 'blue rupee', 'red rupee', 'purple rupee', 'mighty bananas'],
      id: 134,
    ...
    {
      category: 'monsters',
      common_locations: ['East Necluda', 'West Necluda'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Hyrule Ridge', 'Deep Akkala'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Gerudo Desert', 'Hyrule Ridge'],
      description:
        "These quick-witted, lizard-like monsters can be found all over Hyrule. The can emit strong electrical currents from their bodies, so don't get too close. Their horns are brimming with electricity, which will discharge and arc to nearby areas if struck by an arrow. They tend to live in desert climates.",
      drops: ['lizalfos horn', 'lizalfos tail', 'yellow lizalfos tail'],
      id: 119,
    ...
    {
      category: 'monsters',
      common_locations: ['Gerudo Desert', 'Gerudo Highlands'],
      description:
        "This common species is a nuisance all over Hyrule. They're tougher and have stronger weapons than the red Bokoblins - and are a little more clever, as well. At the very least, they have figured out that they can simply kick a Remote Bomb out of the way to avoid its blast.",
      drops: ['bokoblin horn', 'bokoblin fang', 'bokoblin guts'],
      id: 104,
    ...
    {
      category: 'monsters',
      common_locations: ['Hyrule Field', 'Akkala Highlands'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Tabantha Frontier', 'Gerudo Desert'],
      description:
        'These quick-witted, lizard-like monsters can be found all over Hyrule. Compared to the green Lizalfos, many of these carry much stronger weapons and are generally much tougher.',
    ...
    {
      category: 'monsters',
      common_locations: ['Hyrule Ridge', 'West Necluda'],
      description:
        'These spell-casting monsters can be found all over Hyrule. They use their lightning rods to hurl balls of electricity or to summon monsters surging with electricity and have been known to cause thunderstorms in the area. The weather will normalize once the Wizzrobe has been defeated.',
      drops: [],
      id: 99,
    ...
    {
      category: 'monsters',
      common_locations: ['Eldin Mountains', 'Tabantha Frontier'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['West Necluda', 'East Necluda'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Eldin Canyon', 'Gerudo Highlands'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Great Hyrule Forest', 'Gerudo Highlands'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Hyrule Field', 'Deep Akkala'],
      description:
        "These fearsome monsters have lived in Hyrule since ancient times. Compared to the standard Lynel, those with blue manes much tougher and equipped with much stronger weapons. Facing off against a Lynel is ill-advised, but if you must, be sure you're well prepared.",
      drops: ['lynel horn', 'lynel hoof', 'lynel guts'],
      id: 122,
    ...
    {
      category: 'monsters',
      common_locations: ['Lake Hylia', 'Lake Floria'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Divine Beast Vah Medoh'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Gerudo Highlands', 'Gerudo Desert'],
      description:
        "These particularly clever monsters bury themselves in deep sand or snow and disguise themselves as treasure chests. Anyone who approaches the chests is attacked. The treasures chests are not magnetic, which proves that they are actually a part of these monsters' bodies.",
      drops: [
        'octorok tentacle',
        'octo balloon',
        'octorok eyeball',
    ...
    },
    {
      ...
      drops: ['amber', 'opal', 'topaz', 'ruby', 'sapphire', 'mighty bananas'],
      id: 135,
    ...
    {
      category: 'monsters',
      common_locations: ['Divine Beast Vah Naboris'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Mount Lanayru'],
      description:
    ...
    },
    {
      ...
      common_locations: null,
      description:
        "The Malice has given these Moblin skulls a pitiful life after death. The only fragment of their former selves they've held on to is the ferocity innate to all Moblins, so they will attack anyone that approaches.",
      drops: [],
      id: 157,
    ...
    {
      category: 'monsters',
      common_locations: ['Yiga Clan Hideout'],
      description:
    ...
    {
      category: 'monsters',
      common_locations: ['Hebra Mountains', 'Gerudo Highlands'],
      description:
      ...
      drops: ['ice keese wing', 'keese eyeball'],
      id: 90,
    ...
    {
      category: 'monsters',
      common_locations: ['Gerudo Highlands', 'Hyrule Field'],
      description:
      ...
      drops: ['flint', 'amber', 'opal', 'luminous stone', 'topaz', 'diamond'],
      id: 139,
    ...
    {
      category: 'monsters',
      common_locations: ['Hyrule Field', 'Great Hyrule Forest'],
      description:
    ...
    },
    {
      ...
      drops: ['flint', 'opal', 'sapphire', 'diamond'],
      id: 142,
    ...
    },
    {
      ...
      common_locations: null,
      description:
        'These Lizalfos have been influenced by Ganon\'s fiendish magic to become the strongest Lizalfos of all. They\'re called "silver" for their unique coloring and also to denote their rarity. Their purple pattern makes them even more distinct.',
      drops: [
        'lizalfos horn',
        'lizalfos talon',
        'lizalfos tail',
    ...
    },
    {
      ...
      common_locations: ['Hyrule Field', 'Tabantha Frontier'],
      description:
        'These spell-casting monsters can be found all over Hyrule. They use their thunderstorm rods to hurl balls of electricity or to summon monsters surging with electricity and have been known to cause thunderstorms in the area. The weather will normalize once the Wizzrobe is defeated.',
      drops: [],
      id: 102,
    ...
    {
      category: 'monsters',
      common_locations: ['Eldin Canyon', 'Gerudo Desert'],
      description:
        'These quick-witted, lizard-like monsters can be found all over Hyrule. Their fiery breath makes them pretty dangerous, but exposure to cold will kill them instantly. They mainly make their homes in volcanic areas but have also been sighed in the Akkala region.',
      drops: ['lizalfos horn', 'lizalfos talon', 'red lizalfos tail'],
      id: 117,
    ...
    },
    {
      ...
      common_locations: ['Hyrule Field', 'Eldin Canyon'],
      description:
        "These heavyweight monsters can be found all over Hyrule and are among the most dangerous types of Moblin. They're extremely resilient and are often armed with some of the strongest weapons Moblins can carry.",
      drops: ['moblin horn', 'moblin fang', 'moblin guts'],
      id: 110,
    ...
    },
    {
      ...
      drops: ['ancient screw', 'ancient spring'],
      id: 130,
    ...
    {
      category: 'monsters',
      common_locations: ['Hyrule Field', 'Hyrule Castle'],
      description:
        'The Sheikah of ancient Hyrule developed this as a weapon to combat Ganon, but it was destroyed during the Great Calamity. Ages of weather and neglect have left it in a state of disrepair. Approach with caution; some of the derelict models have been known to awaken from stasis and attack when approached.',
      drops: ['ancient screw', 'ancient spring', 'ancient gear', 'ancient shaft'],
      id: 129,
    ...
    },
    {
      ...
      common_locations: ['Hyrule Field', 'Hebra Mountains'],
      description:
        'These quick-witted, lizard-like monsters can be found all over Hyrule. This particular type tends to carry some pretty strong weapons, so they are among the most dangerous Lizalfos.',
      drops: ['lizalfos horn', 'lizalfos talon', 'lizalfos tail'],
      id: 115,
    ...
    },
    {
      ...
      common_locations: ['Gerudo Highlands', 'Hyrule Field'],
      description:
        'These spell-casting monsters can be found all over Hyrule. They use their ice rods to create freezing blasts of air or to summon frozen monsters and have been known to cause blizzards to severely decrease the temperatures around them. The weather will normalize once the Wizzrobe is defeated.',
      drops: [],
      id: 98,
    ...
    {
      category: 'monsters',
      common_locations: ['Lanayru Great Spring', 'East Necluda'],
      description:
      ...
      drops: ['electric keese wing', 'keese eyeball'],
      id: 91,
    ...
    {
      category: 'monsters',
      common_locations: ['West Necluda', 'Hyrule Field'],
      description:
...
test('Monster List Page renders monster images', async () => {
  render(
    <MemoryRouter initialEntries={['/monsterlist']}>
      <Route path="/monsterlist">
        <MonsterList monsters={mockmonsters} />
      </Route>
      );
    </MemoryRouter>
  );
